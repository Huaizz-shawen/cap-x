...
OUT_ROOT="${GLOBAL_ROOT}/runs/lora_sft_lift_success_warmup_0619"
MERGED_MODEL="${GLOBAL_ROOT}/models/lora_sft_lift_success_warmup_0619_merged"
...
python "${TRAIN_SCRIPT}" \
  ...
  --train-jsonl "${SFT_ROOT}/train.jsonl" \
  --output-dir "${OUT_ROOT}" \
