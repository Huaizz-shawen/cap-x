...
MODEL_LABEL="${MODEL_LABEL:-oracle_${DATA_SOURCE}}"
OUT_ROOT="${OUT_ROOT:-${RFT_ROOT}/evals/local_oracle_${DATA_SOURCE}}"
OUTPUT_NAME="${OUTPUT_NAME:-oracle}"
...
"${CAPX_VENV}/bin/python" "${RFT_ROOT}/scripts/eval_capx_oracle_fair.py" \
